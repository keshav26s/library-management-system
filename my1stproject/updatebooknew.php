...
?>
    ...
    <form method="post">
    <label id="first">Enter Book ID you want to change</label><br/>
	
    <input type="number" name="book_id"><br/>
	<h1 align=center>Update the following details</h1>
<br>
...
<?php
if(isset($_POST['save'])){
    $sql = "UPDATE book SET title='".$_POST["title"]."', edition='".$_POST["edition"]."', no_left='".$_POST["no_left"]."', language='".$_POST["language"]."',type='".$_POST["type"]."',b_mem_id='".$_POST["b_mem_id"]."',issue_id='".$_POST["issue_date"]."',return_date='".$_POST["return_date"]."',date_late='".$_POST["days_late"]."',fine='".$_POST["fine"]."',authored_by='".$_POST["authored_by"]."',published_by='".$_POST["published_by"]."',publish_date='".$_POST["publish_date"]."'  where book_id='".$_POST["book_id"]."'";
